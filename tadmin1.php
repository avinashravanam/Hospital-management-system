...
if(isset($_POST['docsub']))
{
  ...
  echo "<script> console.log('$doctor');</script>";
  echo "<script> console.log('$dpassword');</script>";
  echo "<script> console.log('$demail');</script>";
  echo "<script> console.log('$spec');</script>";
  echo "<script> console.log('$docFees');</script>";
  echo "<script> console.log('adding');</script>";

  $query1= "select * from doctor where email='$demail';";
  $result1=mysqli_query($con,$query1);

  echo "<script> console.log('adding1');</script>";

  if(mysqli_num_rows($result1)==1)
  {
    echo "<script>alert('Doctor alreay exists');</script>"; 
  }
  else
  {
        $query="insert into doctor(name,password,email,specialization,fee)values('$doctor','$dpassword','$demail','$spec','$docFees')";
...
if(isset($_POST['docsub1']))
{
  ...
  $query1 = "SELECT *
             FROM doctor 
             WHERE email= '$demail' AND working_status = 1";
   ...
   if(mysqli_num_rows($result1)==1)
	{
        $query="UPDATE doctor
                ...
                WHERE email='$demail' AND password = '$dpassword';";
    ...
    {  
        echo "<script>alert('doctor do not exit');</script>";
   }
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    $con=mysqli_connect("localhost","root","","tempdb");
                    global $con;
                    $query = "SELECT doctor.name AS doctor,appointment.patient_id AS patient_id ,appointment.app_id AS app_id ,patient.name AS name,date,time,disease,medicine
                              FROM prescription 
   ...
   <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-pat-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select app_id,patient.patient_id AS patient_id,gender,contact,patient.email AS email,fee,patient.name AS name,doctor.name AS doctor,fee,date,time,app_status,patient_status,doctor_status 
                              from appointment 
                              join doctor ON appointment.doctor_id = doctor.doctor_id
                              join patient ON appointment.patient_id = patient.patient_id";
                    $result = mysqli_query($con,$query);
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                    <?php if(($row['patient_status']==1) && ($row['doctor_status']==1))  
                    {
                      echo "Active";
                    }
                    ...
                    if(($row['patient_status']==0) && ($row['doctor_status']==0))  
                    {
    ...
    <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="tadmin1.php">
          <div class="row">

                  <div class="col-md-4"><label>Doctor Name:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="doctor" required></div><br><br>
                  <div class="col-md-4"><label>Specialization:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="specialization" required></div><br><br>
